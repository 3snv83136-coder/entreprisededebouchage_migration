...
<ul>
  <li>Dans les coudes et les changements de direction des canalisations, où l'écoulement ralentit.</li>
  <li>Sur les résistances des chauffe-eau et des lave-linges, formant une croûte isolante qui réduit l'efficacité thermique.</li>
  <li>À la jonction des tuyaux, là où les soudures créent des micro-aspérités favorisant l'accroche des dépôts.</li>
  <li>Dans les joints de robinets et les pommes de douche, obstruant progressivement les orifices.</li>
</ul>
<p>Avec le temps, la couche de tartre forme une surface rugueuse qui capte aussi les graisses, les résidus alimentaires et les cheveux. C'est la combinaison de ces dépôts minéraux et organiques qui provoque les bouchons tenaces, difficiles à déboucher avec de simples produits ménagers.</p>

<h2>Les solutions pour limiter l'impact du calcaire</h2>
<h3>Les détartrants réguliers</h3>
...
`,
  ...
  {
    slug: 'wc-deborde-dimanche',
    titre: 'WC débordant un dimanche soir : que faire avant d\'appeler ?',
    description:
      'WC bouché en urgence un dimanche ? Voici les étapes à suivre immédiatement pour limiter les dégâts avant l\'arrivée du technicien.',
    date: '2026-02-03',
    auteur: 'Technicien en assainissement — 19 ans d\'expérience',
    categorieSlug: 'guide',
    tempsLecture: 4,
    tags: ['urgence', 'WC bouché', 'week-end', 'DIY'],
    contenu: `
<p>Dimanche soir, 21h. Les WC débordent. La baignoire fait des gargouillis. Et demain matin, toute la famille doit utiliser la salle de bain. C'est l'une des situations les plus stressantes qui soit en matière de plomberie — et pourtant, quelques gestes simples peuvent faire la différence entre une nuit gérable et une catastrophe.</p>
<p>Voici le protocole étape par étape d'un technicien en débouchage qui a géré des centaines de ces situations.</p>

<h2>Étape 1 : fermez l'arrivée d'eau immédiatement</h2>
<p>C'est le geste le plus important et le premier à faire. Derrière chaque WC se trouve un robinet d'arrêt (aussi appelé vanne d'isolement). Il est généralement situé sur le tuyau d'alimentation, proche du sol ou du mur, juste derrière la cuvette. Tournez-le dans le sens des aiguilles d'une montre jusqu'à la butée.</p>
<p>Si vous ne trouvez pas ce robinet, coupez l'eau générale de l'appartement ou de la maison. Elle se trouve généralement dans le tableau de distribution, souvent sous l'évier de cuisine, dans un placard technique ou à l'entrée de l'appartement.</p>
<p><strong>Pourquoi c'est essentiel :</strong> tant que l'eau continue d'arriver, chaque utilisation accidentelle (chasse tirée par réflexe, autre arrivée d'eau reliée) aggrave la situation et peut transformer un bouchon gérable en inondation de salle de bain.</p>

<h2>Étape 2 : n'actionnez plus la chasse d'eau</h2>
<p>C'est l'erreur classique. Par réflexe ou par espoir que "ça passe", on tire la chasse une deuxième, une troisième fois. Résultat : on envoie 6 à 9 litres d'eau supplémentaires dans une canalisation déjà obstruée. L'eau n'a nulle part où aller et déborde inévitablement.</p>
<p>Prévenez tous les membres du foyer : <strong>aucune utilisation des WC tant que le problème n'est pas résolu</strong>. Posez un Post-it sur la chasse si nécessaire.</p>

<h2>Étape 3 : protégez le sol et aérez la pièce</h2>
<p>Si de l'eau a déjà débordé, étalez des serviettes éponges ou des chiffons absorbants autour de la cuvette pour limiter la propagation. Les parquets, stratifiés et moquettes sont particulièrement sensibles à l'humidité — agir vite limite les dégâts matériels.</p>
<p>Ouvrez la fenêtre ou activez la VMC. Les émanations d'eaux usées contiennent du sulfure d'hydrogène (H₂S), un gaz malodorant et irritant à haute concentration.</p>

<h2>Étape 4 : tentez la ventouse (mais correctement)</h2>
<p>Si le bouchon est récent et situé dans la cuvette elle-même ou juste après le siphon, une ventouse WC peut suffire. Attention : il faut une ventouse à cloche (modèle spécifique WC, en forme de cloche ou d'accordéon) et non une ventouse plate d'évier — elle sera inefficace.</p>
<p>Technique correcte :</p>
<ul>
  <li>Assurez-vous qu'il reste suffisamment d'eau dans la cuvette pour couvrir la ventouse (ajoutez de l'eau froide avec un seau si nécessaire).</li>
  <li>Placez la ventouse bien centrée sur l'orifice de vidange, en assurant un joint parfait.</li>
  <li>Pompez vigoureusement 10 à 15 fois avec des mouvements de va-et-vient rapides.</li>
  <li>Tirez brusquement vers le haut à la fin pour créer un effet de succion.</li>
  <li>Répétez 3 à 4 cycles si nécessaire.</li>
</ul>
<p>Si l'eau commence à s'évacuer normalement après quelques pompages, le bouchon superficiel est résolu. Faites couler l'eau du robinet quelques minutes pour vérifier que l'écoulement est libre.</p>

<h2>Étape 5 : reconnaître quand c'est irrémédiable sans professionnel</h2>
<p>Certains signes indiquent que la situation dépasse le cadre du DIY :</p>
<ul>
  <li><strong>Le bouchon est profond :</strong> la ventouse ne fait aucun effet malgré plusieurs essais. Le bouchon est probablement situé à plus de 1 mètre de la cuvette, dans la canalisation principale.</li>
  <li><strong>Plusieurs équipements sont touchés :</strong> si la douche, la baignoire ou les autres WC sont également lents ou gargouillent, c'est un bouchon sur la colonne principale — seul un équipement professionnel (furet électrique ou hydrocureur) peut en venir à bout.</li>
  <li><strong>Une odeur d'égout envahit plusieurs pièces :</strong> signe d'un bouchon profond avec reflux de gaz.</li>
  <li><strong>Un objet solide a été avalé :</strong> jouet, smartphone, objet de salle de bain. La ventouse ne peut pas déloger un corps étranger solide — et forcer peut l'enfoncer davantage.</li>
</ul>
...
<ul>
  <li><strong>Fractures et fissures :</strong> dues au tassement des sols, aux racines ou au vieillissement des matériaux (fonte, grès, PVC).</li>
  <li><strong>Décollements et joints ouverts :</strong> entre deux sections de tuyau, créant des points d'intrusion de racines ou d'eau souterraine.</li>
...
<h3>Mauvaises odeurs persistantes</h3>
<p>Des odeurs d'égout qui persistent malgré le nettoyage des siphons révèlent souvent une fissure dans la canalisation (qui permet aux gaz de s'échapper) ou un joint défaillant. La caméra localise précisément l'anomalie, permettant une réparation ciblée plutôt qu'un remplacement complet.</p>

<h3>Avant et après un hydrocurage intensif</h3>
<p>Pour les réseaux d'assainissement en copropriété ou pour les établissements recevant du public (restaurants, hôtels), une inspection caméra annuelle ou bisannuelle est recommandée pour valider l'état du réseau et anticiper les réparations.</p>

<h2>Déroulement d'une inspection et durée</h2>
<p>Une inspection caméra standard dure entre 45 minutes et 2 heures selon la complexité du réseau et le nombre de tronçons à inspecter. Le technicien commence par identifier les points d'accès (regards de visite, siphons de sol, gardes d'eau) pour introduire la caméra. Il n'est généralement pas nécessaire de vider les lieux ou de couper l'eau.</p>
<p>À l'issue de l'inspection, vous recevez :</p>
<ul>
  <li>Un rapport écrit avec localisation des anomalies (distance depuis le point d'entrée).</li>
  <li>La vidéo complète de l'inspection, enregistrée sur support numérique.</li>
...
`,
  ...
  {
    slug: 'hydrocurage-vs-furet',
    titre: 'Hydrocurage ou furet : lequel choisir selon votre problème ?',
    description:
      'Furet mécanique ou hydrocurage haute pression : deux techniques très différentes. Voici comment choisir selon la nature du bouchon.',
    date: '2026-03-05',
    auteur: 'Technicien en assainissement — 19 ans d\'expérience',
    categorieSlug: 'guide',
    tempsLecture: 5,
    tags: ['hydrocurage', 'furet', 'technique', 'comparatif'],
    contenu: `
<p>Quand un technicien arrive chez vous pour un bouchon, il ne sort pas son matériel au hasard. Le choix entre le furet mécanique et l'hydrocureur haute pression dépend de la nature exacte du bouchon, du diamètre et de l'état de la canalisation, et de la localisation du problème. Voici le raisonnement qu'un professionnel applique en pratique.</p>

<h2>Le furet mécanique : pour quoi et comment ?</h2>
<p>Le furet est un câble spiralé en acier, rigide mais flexible, introduit manuellement ou via un moteur électrique dans la canalisation. Sa tête rotative coupe, perce ou enroule le bouchon. Il existe des furets manuels (pour les petits calibres, 32 à 50 mm) et des furets électriques professionnels (50 à 150 mm de diamètre, portée jusqu'à 30 mètres).</p>
<p><strong>Le furet est idéal pour :</strong></p>
<ul>
  <li>Les bouchons formés d'amas de cheveux dans les siphons de douche ou lavabo.</li>
  <li>Les accumulations de savon et produits cosmétiques dans les canalisations de salle de bain.</li>
  <li>Les bouchons récents localisés près du point d'usage (moins de 5 mètres).</li>
  <li>Les canalisations qui ne supportent pas la haute pression (tuyaux anciens fissurés ou fragilisés).</li>
</ul>
<p><strong>Ses limites :</strong> le furet perce ou déplace le bouchon mais ne nettoie pas les parois. Après son passage, les dépôts qui restent collés sur la paroi continuent d'accumuler les matières. C'est une solution efficace mais à effet limité dans le temps si le problème est structurel.</p>

<h2>L'hydrocurage haute pression : puissance et propreté</h2>
<p>L'hydrocureur projette de l'eau à très haute pression (80 à 200 bars selon le diamètre de la canalisation) via une lance rotative à l'extrémité d'un flexible. Cette technique ne se contente pas de percer le bouchon : elle décape les parois, emporte les dépôts de graisse et de tartre, et laisse la canalisation propre. C'est à la fois un outil de débouchage et d'entretien.</p>
...
<h2>Quand les deux techniques sont combinées</h2>
<p>Dans certains cas, les deux outils travaillent ensemble. Le furet est d'abord utilisé pour percer le bouchon et restaurer un minimum d'écoulement. Puis l'hydrocureur intervient pour nettoyer les parois et éliminer les dépôts résiduels. Cette approche combinée est typiquement utilisée pour les bouchons anciens et compacts, ou quand l'inspection préalable révèle plusieurs types de dépôts superposés.</p>
...
<p>Faites couler de l'eau chaude (non bouillante pour les canalisations PVC) pendant 2 minutes dans chaque évier après utilisation intensive. Cette habitude simple dissout les résidus de graisse avant qu'ils ne s'accumulent. Pour les WC, versez occasionnellement un peu de liquide vaisselle dilué dans la cuvette — le tensioactif aide à maintenir les parois propres.</p>

<h3>Chaque mois</h3>
<p>Nettoyage préventif au bicarbonate et vinaigre blanc :</p>
<ul>
  <li>Versez 3 cuillères à soupe de bicarbonate de soude directement dans le siphon.</li>
  <li>Ajoutez 200 ml de vinaigre blanc chaud.</li>
  <li>Laissez réagir et mousser pendant 15 minutes.</li>
  <li>Rincez abondamment à l'eau chaude.</li>
</ul>
<p>Cette réaction acide-base dissout les dépôts organiques légers et désodorise les siphons. C'est une solution 100 % naturelle, sans risque pour les canalisations et l'environnement — particulièrement pertinente si vous avez une fosse septique, car elle ne dégrade pas les bactéries de décomposition.</p>

<h3>Tous les 6 mois</h3>
<p>Nettoyage approfondi avec un produit détartrant acide (acide citrique en poudre, disponible en droguerie). Concentrez-vous sur les éviers de cuisine et les siphons de douche, là où les dépôts se forment le plus vite. Vérifiez l'écoulement de chaque équipement : un ralentissement par rapport à l'ordinaire est le premier signe d'une obstruction en formation.</p>
...
<h2>Les signes d'alerte précoces à ne pas ignorer</h2>
<p>Entre deux entretiens, soyez attentif à ces indicateurs :</p>
<ul>
  <li><strong>Écoulement ralenti :</strong> l'eau met plus de temps à s'évacuer que d'habitude. C'est le premier signe d'une obstruction partielle.</li>
  <li><strong>Gargouillis dans les tuyaux :</strong> les bruits d'air qui cherche à passer signalent un bouchon partiel qui crée une dépression.</li>
  <li><strong>Odeurs d'égout intermittentes :</strong> souvent dues à un siphon asséché (si vous partez en vacances, versez une cuillère d'huile dans chaque siphon avant de fermer) ou à une fissure dans la canalisation.</li>
  <li><strong>Remontées dans d'autres équipements :</strong> vous videz l'évier et la douche gargouille — signe d'un bouchon en aval, sur la canalisation principale.</li>
</ul>
