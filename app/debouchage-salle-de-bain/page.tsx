...
const faqs = [
  ...
  },
  {
    ...
    "answer": "Oui, surtout dans les Bouches-du-Rhône où l'eau est très calcaire. Le tartre réduit progressivement le diamètre des canalisations jusqu'à les obstruer."
  },
  {
    "question": "Faut-il un adoucisseur d'eau pour éviter les bouchons ?",
    "answer": "C'est recommandé dans les Bouches-du-Rhône. Un adoucisseur réduit le calcaire et prolonge la durée de vie de vos canalisations."
  },
  {
...
const content = {
  intro: `Une salle de bain regroupe plusieurs sources de bouchons distinctes : la douche et la baignoire accumulent cheveux et savon, le lavabo reçoit dentifrice, savon liquide et résidus de rasage, et l'évacuation au sol collecte le tout. Dans les Bouches-du-Rhône, l'eau calcaire (TH élevé) aggrave chacun de ces points en déposant du tartre sur les parois des siphons et canalisations. Plutôt que de gérer ces problèmes un par un, notre service de débouchage salle de bain prend en charge l'ensemble du réseau en une seule visite : diagnostic complet de tous les équipements, débouchage prioritaire de l'obstruction principale, traitement de tous les siphons et raccords. Avec 19 ans d&apos;expérience dans les Bouches-du-Rhône, nous intervenons vite et garantissons le résultat.`,
  problems: `Les bouchons de salle de bain sont causés par l'accumulation de cheveux mélangés au savon, formant un bouchon compact et collant. Le calcaire, très présent dans l'eau des Bouches-du-Rhône, aggrave le problème en réduisant le diamètre des canalisations. Si plusieurs sanitaires de la salle de bain s'écoulent mal en même temps, le bouchon est probablement dans la canalisation commune.`,
  ...
  conseils: `Pour maintenir votre salle de bain en bon état durablement, adoptez un entretien mensuel global : versez un détartrant naturel (acide citrique ou vinaigre blanc dilué) dans chacune des évacuations — douche, baignoire, lavabo — et laissez agir 20 minutes avant de rincer à l'eau chaude. Ce geste mensuel ralentit significativement les dépôts calcaires dans les Bouches-du-Rhône. Posez également un filtre sur toutes les évacuations : grille attrape-cheveux sur la bonde de douche et de baignoire, tamis fin sur le lavabo. Nettoyez ces filtres chaque semaine. Ces deux habitudes réduisent de 80 à 90% le risque de bouchon récurrent.`
};
