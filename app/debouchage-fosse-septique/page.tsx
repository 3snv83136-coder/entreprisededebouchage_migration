...
const faqs = [
  {
    "question": "À quelle fréquence faut-il vidanger une fosse septique dans le Var ?",
  ...
  },
  {
    ...
    "answer": "Le SPANC est le service de contrôle des installations d'assainissement non collectif, rattaché à votre commune ou à votre communauté de communes dans le Var. Il contrôle la conformité de votre fosse et peut exiger des travaux de mise en conformité. Lors de la vente d'un bien, un rapport SPANC datant de moins de 3 ans est obligatoire. Nous vous remettons un compte-rendu d'intervention à transmettre à votre SPANC après chaque vidange."
  },
  {
...
const content = {
  ...
  tarif: `La vidange de fosse septique est facturée à partir de 199€ selon le volume de la fosse (en m³) et la distance depuis notre dépôt varois. Ce tarif inclut le déplacement, la vidange complète, le curage des parois et la remise du rapport d'intervention. Le rapport SPANC est fourni sans supplément. Un devis gratuit est établi par téléphone avant l'intervention sur la base du volume déclaré de votre fosse. Aucun frais caché n'est ajouté sur place. Appelez-nous pour obtenir votre tarif personnalisé selon votre commune.`,
  ...
  signes: `Les signaux d'alerte d'une fosse à vidanger ne se limitent pas aux odeurs. Un sol spongieux ou des zones humides permanentes au-dessus de la fosse ou du champ d'épandage montrent que les effluents surchargent le sol. Une herbe anormalement verte et haute sur cette zone précise, en toutes saisons, est un indicateur classique de débordement lent. À l'intérieur, des toilettes qui évacuent lentement sur l'ensemble de la maison (et pas un seul WC), des gurgouillis dans plusieurs évacuations simultanément et des odeurs de gaz persistants dans les WC indiquent une fosse saturée. Dès que deux de ces signes sont réunis, appelez-nous sans attendre.`,
