...
const faqs = [
  {
    "question": "Combien de temps dure un debouchage de canalisation ?",
...
const content = {
  ...
  tarif: `Le tarif d'un debouchage de canalisation varie selon la profondeur de l'obstruction et la méthode utilisée. Un debouchage simple au furet est moins coûteux qu'un hydrocurage haute pression. Nous vous communiquons le prix exact par téléphone avant tout déplacement.`,
};
