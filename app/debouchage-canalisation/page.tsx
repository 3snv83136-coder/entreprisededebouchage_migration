...
const content = {
  ...
  steps: [
    ...
    },
    {
      ...
      text: "Notre équipe intervient rapidement dans tout les Bouches-du-Rhône pour les urgences. Le technicien arrive avec le matériel complet : caméra endoscopique, hydrocureur haute pression et furet motorisé."
    },
    {
  ...
  conseils: `Quelques habitudes simples prolongent la durée de vie des canalisations, surtout dans les Bouches-du-Rhône où l&apos;eau calcaire accélère le colmatage. Ne versez jamais d&apos;huiles de cuisson dans l&apos;évier : stockez-les dans un contenant hermétique pour les déposer en déchetterie. Utilisez un détartrant liquide compatible canalisations une fois par mois pour limiter les dépôts. Évitez les lingettes dans les WC, même celles dites biodégradables. Pour les maisons avec jardin, planifiez un hydrocurage préventif du réseau extérieur tous les deux ans : dans les Bouches-du-Rhône, l&apos;eau calcaire et les racines forment une combinaison particulièrement agressive pour les conduites.`,
  tarif: `Le débouchage au furet motorisé est facturé à partir de 110 € TTC, déplacement inclus. L&apos;hydrocurage haute pression, recommandé pour les dépôts de calcaire et les graisses, est à partir de 249 € TTC. L&apos;inspection par caméra endoscopique est disponible seule à 180 € TTC ou incluse dans l&apos;intervention complète. Le déplacement est toujours inclus dans le tarif annoncé. Nous communiquons un prix fixe par téléphone avant d&apos;intervenir : aucun supplément ne peut être ajouté sans votre accord préalable. Devis gratuit sur simple appel.`
};
