...
const content = {
  ...
  steps: [
    ...
    {
      name: "Arrivée du technicien (moins d&apos;une heure)",
      text: "Notre équipe intervient dans tout le Var en moins d&apos;une heure pour les urgences. Le technicien arrive avec le matériel complet : caméra endoscopique, hydrocureur haute pression et furet motorisé."
    },
    {
