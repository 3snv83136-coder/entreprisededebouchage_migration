...
const content = {
  ...
  tarif: `Le débouchage de cuisine est une intervention courante. Le coût dépend de la méthode utilisée : furet pour les bouchons légers, hydrocurage pour les bouchons graisseux tenaces. Devis gratuit par téléphone.`,
};
