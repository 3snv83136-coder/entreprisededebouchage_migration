...
const faqs = [
  ...
  {
    question: `Quel est le tarif pour un débouchage lave-linge dans les Bouches-du-Rhône ?`,
    answer: `Le débouchage du circuit de vidange d'un lave-linge est facturé à partir de 110 € dans les Bouches-du-Rhône. Ce tarif comprend le déplacement, la vidange manuelle, le nettoyage du filtre et de la pompe, le débouchage du flexible et de la canalisation si nécessaire, et le test de cycle d'essorage complet avant départ.`,
  },
];

const content = {
  intro: `Un lave-linge qui s'arrête en plein cycle avec de l'eau en fond de tambour affiche souvent le code erreur F21 ou E21 : la pompe de vidange ne parvient pas à évacuer l'eau à temps. Dans les Bouches-du-Rhône, où la dureté de l'eau avoisine 30 à 35°f, le calcaire encroûte progressivement la pompe et réduit le diamètre interne du flexible d'évacuation, aggravant les problèmes de vidange. Le filtre de pompe obstrué par des peluches, des pièces de monnaie ou des fibres synthétiques est la cause la plus fréquente. Entreprise de Débouchage intervient dans tout les Bouches-du-Rhône à partir de 110 € pour rétablir la vidange complète — filtre, pompe et canalisation — avec un test de cycle d'essorage validé sur place avant départ.`,
  problems: `Les problèmes de vidange d'un lave-linge sont souvent cumulatifs : le filtre de pompe se bouche progressivement par les peluches et fibres, ce qui force la pompe à travailler en surchauffe. Simultanément, le calcaire de l'eau dure des Bouches-du-Rhône encroûte la roue de pompe et le flexible d'évacuation. Le résultat : la machine s'arrête en cours de cycle avec un code erreur pompe, de l'eau restante en fond de tambour, et parfois des claquements caractéristiques indiquant que la roue de pompe racle un corps étranger (pièce de monnaie, bouton, agrafes métalliques).`,
  ...
  tarif: `Débouchage lave-linge à partir de 110 € dans les Bouches-du-Rhône, déplacement inclus. Tarif fixe annoncé avant intervention. Test de cycle d'essorage complet effectué sur place avant départ.`,
  steps: [
    {
