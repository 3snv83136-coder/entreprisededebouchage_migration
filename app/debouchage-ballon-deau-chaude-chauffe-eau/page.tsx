...
const faqs = [
  {
    question: `À quelle fréquence faut-il détartrer un ballon d'eau chaude dans les Bouches-du-Rhône ?`,
    answer: `Dans les Bouches-du-Rhône, la dureté de l'eau atteint 25 à 35°f selon les secteurs — parmi les plus élevées de France. Nous recommandons un détartrage annuel pour maintenir le rendement du ballon et éviter l'entartrage de la résistance. Sans entretien, un dépôt de tartre de 3 mm sur la résistance augmente la consommation électrique de 20 % et réduit la durée de vie du ballon de moitié.`,
  },
  {
  ...
  {
    question: `Un adoucisseur d'eau suffit-il à protéger le ballon dans les Bouches-du-Rhône ?`,
  ...
  },
  {
    ...
    answer: `Nous intervenons à partir de 110 € pour le détartrage et la remise en état du circuit de sécurité d'un ballon d'eau chaude dans les Bouches-du-Rhône. Depuis 19 ans, nos techniciens traitent tous les types de ballons — électriques verticaux et horizontaux, thermodynamiques, chauffe-eau instantanés au gaz — avec les mêmes garanties de résultat.`,
  },
];

const content = {
  intro: `Dans les Bouches-du-Rhône, la dureté de l'eau atteint 25 à 35°f selon les secteurs — un niveau parmi les plus élevés de France. Cette eau très calcaire entartre progressivement la résistance électrique, le groupe de sécurité et la tuyauterie de votre ballon d'eau chaude ou chauffe-eau. Résultat : eau tiède, consommation électrique en hausse, bruits de claquement à la chauffe et fuite du groupe de sécurité. Entreprise de Débouchage intervient depuis 19 ans dans tout les Bouches-du-Rhône pour le détartrage complet, le rinçage et l'entretien du groupe de sécurité. Nos interventions débutent à partir de 110 €, déplacement inclus, avec un test de pression et de température réalisé sur place avant départ pour garantir le bon fonctionnement de votre installation.`,
  ...
  tarif: `Détartrage et remise en état de ballon d'eau chaude à partir de 110 € dans les Bouches-du-Rhône. Tarif fixe comprenant le déplacement, l'ensemble de l'intervention et le test de pression et de température final. 19 ans d'expérience sur tous types de ballons électriques, thermodynamiques et chauffe-eau gaz.`,
  steps: [
    {
  ...
  conseils: `Dans les Bouches-du-Rhône, le détartrage annuel de votre ballon d'eau chaude est un investissement qui se rentabilise rapidement sur la facture électrique. Installez un filtre anticalcaire à polyphosphates sur l'arrivée d'eau froide du ballon — c'est la protection la plus économique contre l'entartrage. Faites vérifier le groupe de sécurité chaque année : la réglementation l'impose pour les installations sous pression, et un groupe encrassé ne protège plus votre ballon contre les surpressions.`,
};
