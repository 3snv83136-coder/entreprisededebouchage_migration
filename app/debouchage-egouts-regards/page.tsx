...
const faqs = [
  ...
  },
  {
    ...
    answer: "Oui. Un refoulement d&apos;eaux usées dans une cave, un sous-sol ou un regard constitue une urgence sanitaire. Nous intervenons en moins d&apos;une heure dans tout le Var, sept jours sur sept, y compris les week-ends et jours fériés."
  },
  {
...
const content = {
  ...
  signes: `Plusieurs signaux précoces indiquent qu&apos;un réseau extérieur est en train de se colmater. Des remontées d&apos;eau apparaissent dans un regard qui déborde lors d&apos;une pluie ordinaire. Une odeur sulfureuse (oeuf pourri) se dégage près d&apos;un regard ou d&apos;une zone du jardin, signe de fermentation anaérobie dans le réseau. Le sol autour d&apos;une conduite enterrée est anormalement humide ou affaissé, ce qui peut indiquer une fuite ou un effondrement partiel. En cave ou en sous-sol, un refoulement d&apos;eaux usées — même ponctuel — lors d&apos;une forte pluie est un signal d&apos;alarme à ne pas ignorer.`,
  conseils: `L&apos;entretien régulier d&apos;un réseau extérieur est beaucoup moins coûteux qu&apos;une intervention d&apos;urgence. Ne jetez jamais d&apos;huiles de cuisson, de lingettes ou de produits hygiènes dans les WC ou les éviers : ils finissent systématiquement dans le réseau extérieur. Planifiez un curage préventif du réseau tous les 3 à 5 ans, ou tous les 2 ans si la maison est entourée d&apos;arbres. Après chaque épisode méditerranéen (pluies intenses en automne dans le Var), vérifiez visuellement vos regards : un seul colmaté par des feuilles ou des terres peut bloquer tout le réseau en aval. Enfin, maintenez les abords des regards dégagés pour faciliter les interventions.`,
