...
const faqs = [
  {
    "question": "Qui est responsable du debouchage d'égout ?",
...
const content = {
  ...
  tarif: `Le debouchage d'égout est une intervention plus complexe qui nécessite un véhicule spécialisé. Le tarif dépend de la longueur de canalisation à traiter et du type d'obstruction. Nous établissons un devis gratuit avant toute intervention.`,
};
