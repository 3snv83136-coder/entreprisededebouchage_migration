...
const content = {
  ...
  tarif: `Le debouchage de WC est l'une de nos interventions les plus courantes et les plus abordables. Le tarif dépend de la nature du bouchon : un bouchon simple est traité rapidement, un bouchon profond nécessite plus de temps et de matériel.`,
};
