...
const content = {
  intro: `Un WC bouché dans le Var, c'est une urgence qui ne peut pas attendre. Que vous soyez à Toulon, Fréjus, Draguignan ou dans l'arrière-pays varois, nos techniciens interviennent 24h/24 et 7j/7 pour déboucher vos toilettes en une seule visite. Les causes les plus fréquentes sont les lingettes accumulées dans le siphon, les objets tombés accidentellement (jouets, brosses à dents, téléphones), l'excès de papier toilette ou le calcaire qui rétrécit progressivement le passage dans le siphon céramique. Grâce à notre furet motorisé professionnel, nous résolvons 90% des bouchons sans démontage de la cuvette. Le résultat est garanti dès la première intervention. Forts de 19 ans d'expérience dans le Var, nous savons qu'un bouchon traité rapidement évite un débordement coûteux et des dégâts d'eau sur votre plancher ou au plafond du voisin du dessous.`,
